...
lambert_map_density=single(1e-3);

% get lambert map image

img_lambert=beamsim_lambert_cu(tx',wavenumber,lambert_radius,lambert_map_density);           
...
img_xz=squeeze(beamsim0302_xz_cu(tx',wavenumber,x0,y0,z0,nx,ny,nz,dx,dy,dz));
% convert image to decibel scale
